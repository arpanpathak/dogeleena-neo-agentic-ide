...
return {
  ...
  -- unstable on Neovim 0.12.
  {
    ...
    config = function()
      ...
      -- Block on first install so Markdown/YAML parsers are ready before
      -- CodeCompanion or render-markdown open their buffers.
      local required_parsers = { "markdown", "markdown_inline", "yaml" }
